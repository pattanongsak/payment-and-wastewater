...
function UserPaymentWastWTOfAll({ match }) {
            ...
            for (const info2 of info.selectMonth) {
              if (selectedOption1 === "all") {
                if (info.wastewater && selectedOption === "paymentWastewater") {
                  if (item._id === info.address && item3._id === info2._id) {
                    checkInfoValue.push({
                      id: info2._id,
                      idAddress: item._id,
          ...
          <div className="pageModel">
            <div className="formModel login-wrapper">
              <div className="formReportBox">
                <h1 className="formTitle ">รายงานลูกหนี้ชำระเงินค่าน้ำเสีย</h1>
...
export default UserPaymentWastWTOfAll;
