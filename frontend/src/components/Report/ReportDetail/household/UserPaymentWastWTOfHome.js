...
function UserPaymentWastWTOfHome({ match }) {
  ...
  const [selectedOption] = useState("paymentWastewater");
              ...
              if (selectedOption1 === "all") {
                if (info.wastewater && selectedOption === "paymentWastewater") {
                  if (
                    ...
                    item3._id === info2._id &&
                    info.paymenttype === "ครัวเรือน"
                  ) {
                    checkInfoValue.push({
                      id: info2._id,
                      idAddress: item._id,
                      status: item2.orderStatus,
                      paymentPrice: info.wastewater,
            ...
            <div className="formModel login-wrapper">
              <div className="formReportBox">
                <h1 className="formTitle ">
                  รายงานลูกหนี้ชำระเงินค่าน้ำเสีย ประเภทครัวเรือน
                </h1>
                      ...
                      {alladdress &&
                        alladdress.map((addressItme) => (
                          <tr
                            ...
                            className={
                              selectedOption1 === "all" &&
                              addressItme.paymenttype === "ครัวเรือน"
                                ? ""
...
export default UserPaymentWastWTOfHome;
